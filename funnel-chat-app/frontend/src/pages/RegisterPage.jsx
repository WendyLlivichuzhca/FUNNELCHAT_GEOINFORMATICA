            ...
            <div className="animate-fade-in-up" style={{
                ...
                <div style={{ marginBottom: '40px' }}>
                    ...
                    <h1 style={{ fontFamily: 'Syne', fontSize: '40px', fontWeight: '800', lineHeight: 1.1, color: '#f0f8ff', marginBottom: '10px' }}>
                        ...
                        }}>e inicia el cambio</span>
                    </h1>
                    <p style={{ color: 'rgba(100, 140, 200, 0.6)', fontSize: '15px', fontWeight: '500' }}>Únete a la red más avanzada de automatización.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div>
                        <label style={{ display: 'block', marginBottom: '10px', fontSize: '10px', fontWeight: '800', color: 'rgba(0, 140, 255, 0.35)', textTransform: 'uppercase', letterSpacing: '2px' }}>Nueva Contraseña</label>
                        <div style={{ position: 'relative' }}>
                    ...
                    <div>
                        <label style={{ display: 'block', marginBottom: '10px', fontSize: '10px', fontWeight: '800', color: 'rgba(0, 140, 255, 0.35)', textTransform: 'uppercase', letterSpacing: '2px' }}>Confirmar acceso</label>
                        <div style={{ position: 'relative' }}>
                            <Lock size={18} style={{ position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', color: '#0066ff', opacity: 0.5, transition: 'all 0.3s' }} className="icon-glow" />
                            <input
                                type="password"
                ...
                <div style={{ marginTop: '32px', textAlign: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', opacity: 0.6 }}>
                        ...
                        <span style={{ fontSize: '11px', fontWeight: '700', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase' }}>Acceso</span>
                    ...
                    >
                        <LogIn size={16} /> ¿Ya tienes cuenta? Inicia sesión
                    </button>
                </div>
